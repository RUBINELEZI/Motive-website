...
export default function Footer() {
    return (
        <footer className="text-center lg:text-left text-gray-400 flex flex-col justify-center items-center">
          ...
          ">
            ...
            <div className="text-center p-6">
                ...
                <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">All right reserved</a>
            </div>
        </footer>
    );
}
