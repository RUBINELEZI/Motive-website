    ...
    <footer
      ...
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300 ">
        ...
        <div className="flex justify-center ">
          <a href={content.socialMedia.facebook} className="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href={content.socialMedia.twitter} className="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href={content.socialMedia.email} className="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href={content.socialMedia.instagram} className="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
