    ...
    <footer
      ...
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300 ">
        <div className="mr-12 hidden lg:block ">
          <span>{content.socialMedia.short_text}</span>
        </div>
      </div>
        ...
        <div className="flex flex-col align-baseline md:flex-row justify-between">
          ...
          ">
            ...
            <div className="flex mt-12">
              ...
              <a href={content.socialMedia.twitter} className="mr-6 text-gray-600 hover:text-purple-600">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fab"
              ...
              <a href={content.socialMedia.email} className="mr-6 text-gray-600 hover:text-purple-600">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fab"
              ...
              <a href={content.socialMedia.instagram} className="mr-6 text-gray-600 hover:text-purple-600">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fab"
            ...
            <ul className="flex flex-col list-none justify-center items-center md:items-start">
              {HeaderData?.map((data) => (
                <li key={data.index} className="nav-item cursor-pointer" onClick={() => scrollDown(data.link)}>
                  <a
                    className="py-2 flex items-center uppercase leading-snug hover:text-purple-400 hover:underline hover:underline-offset-4">
