  ...
  return (
    <div className="container p-4 md:p-0 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
        ...
        <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left z-10">
      ...
      <div className="w-full xl:w-3/5 p-12 overflow-hidden">
        <img
          className="mx-auto w-full md:w-4/5 transform -rotate-left-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6"
          src="/heroIphone.png"
          alt="sadsa"
        />
      </div>
